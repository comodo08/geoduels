    ...
    <>
      ...
      >
        ...
        <div
          ...
          onPointerUp={endPointerGesture}
          onPointerCancel={endPointerGesture}
          className={`group relative z-10 min-h-0 w-full origin-bottom-right overflow-hidden rounded-panel border border-white/20 bg-slate-900/70 shadow-elev-4 transition-[height,opacity,box-shadow] duration-150 ease-out ${expanded
