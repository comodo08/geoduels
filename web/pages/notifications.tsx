...
export default function NotificationsPage() {
  ...
  useShowAppNoticeWhen(
    readAll.isError || read.isError || notificationAction.isError,
    "A notification could not be updated. Try again.",
    (readAll.failureCount || 0) + (read.failureCount || 0) + (notificationAction.failureCount || 0),
  );
  return (
