...
const geometryExceptions = new Map(Object.entries({
  ...
  "features/lobby/components/LobbyShellPieces.tsx": ["max-w-[1160px]", "min-h-[112px]", "grid-cols-[minmax(0,1fr)_300px]", "[mask-image:linear-gradient(180deg,black_48%,rgba(0,0,0,0.76)_70%,transparent_100%)]", "[-webkit-mask-image:linear-gradient(180deg,black_48%,rgba(0,0,0,0.76)_70%,transparent_100%)]"],
  ...
  "features/lobby/components/PlayPanel.tsx": ["min-h-[54px]", "scale-[1.01]", "scale-[0.98]", "max-w-[860px]", "min-h-[165px]", "min-h-[180px]", "w-[calc((72rem-2rem)/3)]"],
...
function runSelfTest() {
  ...
  const checks = [
    ...
    ["lobby card thirds geometry exception accepted", check("features/lobby/components/PlayPanel.tsx", "w-[calc((72rem-2rem)/3)]")],
    ["unlisted lobby geometry value rejected", !check("features/lobby/components/PlayPanel.tsx", "w-[999rem]")],
