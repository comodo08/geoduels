...
const tiers = [
  { name: "Base", requirement: "Registered account", maps: 10, locations: "500,000", perUpload: "300,000", throughput: "300,000" },
  { name: "Trusted", requirement: "5 favorites · account age 14 days", maps: 25, locations: "2,500,000", perUpload: "600,000", throughput: "600,000" },
  { name: "Established", requirement: "50 favorites · account age 30 days", maps: 100, locations: "100,000,000", perUpload: "1,000,000", throughput: "1,000,000" },
];
    ...
    <AppModalShell title="Map Upload Limits" onClose={onClose} placement="center" maxWidthClassName="max-w-2xl">
      <div className="space-y-4 text-body-sm text-content-secondary">
        ...
        {quota ? (
          <div className="rounded-lg border border-border-default bg-surface-grouped p-4">
            ...
            <p className="mt-3 text-body-sm">
                ...
                {quota.favoritesNeeded || 0} more favorites
          ...
          {tiers.map((tier) => (
            <div key={tier.name} className="grid gap-2 border-b border-border-default p-4 last:border-b-0 sm:grid-cols-[120px_1fr]">
              ...
              <div className="space-y-1 text-body-sm">
                ...
                <p>{tier.maps} maps · {tier.locations} active locations · {tier.perUpload} locations per upload · {tier.throughput} uploaded locations/hour</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <p className="text-body-sm text-content-secondary">
          Every tier allows 10 uploads per hour and 30 per day. Favorites count once per player, excluding the map owner.
