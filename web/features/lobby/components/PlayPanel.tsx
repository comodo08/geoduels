...
const playModeActionButtonClass =
  "w-full min-h-[54px] rounded-xl px-4 py-0 text-body leading-collapsed transform-gpu transition duration-normal ease-standard hover:scale-[1.01] active:scale-[0.98]";
