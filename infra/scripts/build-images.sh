...
builds=(
  "backend/services/api/Dockerfile|geoduels-api|backend|generic"
  "backend/services/discord-worker/Dockerfile|geoduels-discord-worker|backend|generic"
  "backend/services/match-coordinator/Dockerfile|geoduels-match-coordinator|backend|generic"
  "backend/services/moderation-worker/Dockerfile|geoduels-moderation-worker|backend|generic"
  "backend/services/realtime-gateway/Dockerfile|geoduels-realtime-gateway|backend|generic"
  "backend/services/gameplay-node/Dockerfile|geoduels-gameplay-node|backend|generic"
  "web/Dockerfile|geoduels-web|web|web"
)
